    ...
    fn expand(&self) -> proc_macro2::TokenStream {
        ...
        let impl_pg_res = quote! {
            ...
            impl #ty_generics Resource<Postgres> for #struct_ident #ty_generics #where_clause {
                ...
                async fn upsert<'e, 'c: 'e, E>(&'e self, id: &Option<Self::ResourceID>, exector: E) -> Result<()>
                where
                    E: sqlx::Executor<'c, Database = Any>,
                {
                    let #ids = if let Some(#ids) = id.clone() {
                ...
                async fn update<'e, 'c: 'e, E>(&self, id: &Self::ResourceID, exector: E) -> Result<()>
                where
                E: sqlx::Executor<'c, Database = Any>,
                {
                    let #ids = id.clone();
                ...
                async fn drop<'e, 'c: 'e, E>(id: &Self::ResourceID, exector: E) -> Result<()>
                where
                E: sqlx::Executor<'c, Database = Any>,
                {
                    let #ids = id.clone();
        ...
        let impl_sqlite_res = quote! {
            ...
            impl #ty_generics Resource<Sqlite> for #struct_ident #ty_generics #where_clause {
                type ResourceID = #ids_typ;
                async fn insert<'e, 'c: 'e, E>(&'e self, id: &Option<Self::ResourceID>, exector: E) -> Result<()>
                where
                E: sqlx::Executor<'c, Database = Any>,
                {
                    let #ids = if let Some(#ids) = id.clone() {
                ...
                async fn update<'e, 'c: 'e, E>(&'e self, id: &Self::ResourceID, exector: E) -> Result<()>
                where
                E: sqlx::Executor<'c, Database = Any>,
                {
                    let #ids = id.clone();
